...
namespace Sunny.UI
{
    ...
    [Description("浮点数上下选择框")]
    public partial class UIDoubleUpDown : UIPanel, IToolTip
    {
        ...
        public UIDoubleUpDown()
        {
            ...
            _edit.Type = UITextBox.UIEditType.Double;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (!Text.IsDouble()) Text = Value.ToString("F" + DecimalPlaces);
        ...
        [DefaultValue(0)]
        [Description("浮点数返回值"), Category("SunnyUI")]
        public double Value
        {
            get => _edit.DoubleValue;
            set
            {
                if (_edit.DoubleValue.EqualsDouble(value)) return; // 避免重复赋值引起的事件触发
                _edit.DoubleValue = value;
            }
        }
